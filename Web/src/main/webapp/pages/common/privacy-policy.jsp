...
<nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
    ...
    <!-- Image Logo -->
    <a class="navbar-brand logo-image" href="../../index.jsp"><img src="../../static/images/logo.svg" alt="alternative"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link page-scroll" href="../../index.jsp#header">HOME <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link page-scroll" href="../../index.jsp#intro">INTRO</a>
            </li>
            <li class="nav-item">
                <a class="nav-link page-scroll" href="../../index.jsp#services">SERVICES</a>
            </li>
            <li class="nav-item">
                <a class="nav-link page-scroll" href="../../index.jsp#callMe">CALL ME</a>
            </li>
            <li class="nav-item">
                <a class="nav-link page-scroll" href="../../index.jsp#projects">PROJECTS</a>
            </li>

            <!-- Dropdown Menu -->
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle page-scroll" href="../../index.jsp#about" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">ABOUT</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="../../pages/common/terms-conditions.jsp"><span class="item-text">TERMS CONDITIONS</span></a>
                    <div class="dropdown-items-divide-hr"></div>
                    <a class="dropdown-item" href="../../pages/common/privacy-policy.jsp"><span class="item-text">PRIVACY POLICY</span></a>
                </div>
            </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumbs">
                    <a href="../../index.jsp">Home</a><i class="fa fa-angle-double-right"></i><span>Privacy Policy</span>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="form-container">
                            <form id="privacyForm" data-toggle="validator" data-focus="false">
                                ...
                                <div class="form-group checkbox">
                                    <input type="checkbox" id="pterms" value="Agreed-to-Terms" required>I have read and agree to Aria's <a href="../../pages/common/privacy-policy.jsp">Privacy Policy</a> and <a href="../../pages/common/terms-conditions.jsp">Terms Conditions</a>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group">
                ...
                <a class="btn-outline-reg back" href="../../index.jsp">BACK</a>
            </div> <!-- end of col-->
        </div> <!-- end of row -->
    </div> <!-- end of container -->
            ...
            <div class="col-md-2">
                <div class="text-container">
                    ...
                    <ul class="list-unstyled li-space-lg white">
                        ...
                        <li>
                            <a class="white" href="../../pages/common/terms-conditions.jsp">Terms & Conditions</a>
                        </li>
                        <li>
                            <a class="white" href="../../pages/common/privacy-policy.jsp">Privacy Policy</a>
                        </li>
                    </ul>
                </div> <!-- end of text-container -->
            </div> <!-- end of col -->
