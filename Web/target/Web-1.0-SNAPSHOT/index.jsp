...
<nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link page-scroll" href="#callMe">登录&注册</a>
            </li>
            <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        <h1>Listen <span id="js-rotating"> find music, listen music, enjoy music</span></h1>
                        <p class="p-heading p-large">在这里，进入自己的音乐世界</p>
                        <a class="btn-solid-lg page-scroll" href="#intro">开启音乐世界</a>
                    </div>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="text-container">
                    ...
                    <h2 class="white">Log in to have better experience!</h2>
                    <p class="white">You are just a few steps away from a personal music library. Just fill in the form and hit the button and you will access to our website.</p>
                    <ul class="list-unstyled li-space-lg white">
                        <li class="media">
                            <i class="fas fa-square"></i>
                            <div class="media-body">It's very easy just fill in the form so you can enjoy</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-square"></i>
                            <div class="media-body">If you do not have an account please click the button below</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-square"></i>
                            <div class="media-body">Don't hesitate to join us for any inquiries</div>
                        </li>
                    </ul>
                </div>
            </div> <!-- end of col -->
...
<div id="project-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <a target="_blank" class="btn-solid-reg" href="https://baike.baidu.com/item/%E4%B8%83%E9%87%8C%E9%A6%99/2181450#viewPageContent">详细信息</a> <a class="btn-outline-reg mfp-close as-button" href="#projects">返回</a>
        </div> <!-- end of col -->
    </div> <!-- end of row -->
...
<div id="project-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <a target="_blank" class="btn-solid-reg" href="https://baike.baidu.com/item/11%E6%9C%88%E7%9A%84%E8%90%A7%E9%82%A6/467565?fromtitle=%E5%8D%81%E4%B8%80%E6%9C%88%E7%9A%84%E8%90%A7%E9%82%A6&fromid=468218&fr=aladdin">DETAILS</a> <a class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
        </div> <!-- end of col -->
    </div> <!-- end of row -->
</div> <!-- end of lightbox-basic -->
<!-- end of lightbox -->
...
<div id="project-3" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <a target="_blank" class="btn-solid-reg" href="https://baike.baidu.com/item/%E9%AD%94%E6%9D%B0%E5%BA%A7">DETAILS</a> <a class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
        </div> <!-- end of col -->
    </div> <!-- end of row -->
</div> <!-- end of lightbox-basic -->
<!-- end of lightbox -->
...
<div id="project-4" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <a target="_blank" class="btn-solid-reg" href="https://baike.baidu.com/item/%E6%96%B0%E5%9C%B0%E7%90%83/16184564">DETAILS</a> <a class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
        </div> <!-- end of col -->
    </div> <!-- end of row -->
</div> <!-- end of lightbox-basic -->
<!-- end of lightbox -->
...
<div id="project-5" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <a target="_blank" class="btn-solid-reg" href="https://baike.baidu.com/item/%E5%AD%A6%E4%B8%8D%E4%BC%9A/18898707#viewPageContent">DETAILS</a> <a class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
        </div> <!-- end of col -->
    </div> <!-- end of row -->
</div> <!-- end of lightbox-basic -->
<!-- end of lightbox -->
...
<div id="project-6" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <a target="_blank" class="btn-solid-reg" href="https://baike.baidu.com/item/%E6%94%B9%E5%8F%98%E8%87%AA%E5%B7%B1/18638#viewPageContent">DETAILS</a> <a class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
        </div> <!-- end of col -->
    </div> <!-- end of row -->
</div> <!-- end of lightbox-basic -->
<!-- end of lightbox -->
...
<div id="project-7" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <a target="_blank" class="btn-solid-reg" href="https://baike.baidu.com/item/%E7%81%AB%E5%8A%9B%E5%85%A8%E5%BC%80/33887">DETAILS</a> <a class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
        </div> <!-- end of col -->
    </div> <!-- end of row -->
</div> <!-- end of lightbox-basic -->
<!-- end of lightbox -->
...
<div id="project-8" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <a target="_blank" class="btn-solid-reg" href="https://baike.baidu.com/item/%E5%85%89%E5%B9%B4%E4%B9%8B%E5%A4%96/20318525">DETAILS</a> <a class="btn-outline-reg mfp-close as-button" href="#projects">BACK</a>
        </div> <!-- end of col -->
    </div> <!-- end of row -->
</div> <!-- end of lightbox-basic -->
<!-- end of lightbox -->
            ...
            <div class="col-lg-12">
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <a target="_blank" href="https://baike.baidu.com/item/%E5%91%A8%E6%9D%B0%E4%BC%A6/129156?fr=aladdin"><img class="img-fluid" src="static/images/chou.jpg" alt="alternative"></a>
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <a target="_blank" href="https://baike.baidu.com/item/%E7%8E%8B%E5%8A%9B%E5%AE%8F/104887?fr=aladdin"><img class="img-fluid" src="static/images/leehom.jpg" alt="alternative"></a>
                    </div> <!-- end of image wrapper -->
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <a target="_blank" href="https://baike.baidu.com/item/%E6%9E%97%E4%BF%8A%E6%9D%B0/131821"><img class="img-fluid" src="static/images/JJ.png" alt="alternative"></a>
                    </div> <!-- end of image wrapper -->
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <a target="_blank" href="https://baike.baidu.com/item/%E9%82%93%E7%B4%AB%E6%A3%8B/6798196"><img class="img-fluid" src="static/images/dzq.jpg" alt="alternative"></a>
                    </div> <!-- end of image wrapper -->
