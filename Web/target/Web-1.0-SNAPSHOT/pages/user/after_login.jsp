            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <form data-toggle="validator" data-focus="false" action="zoneServlet" method="get">
                            <input type="hidden" name="action" value="search">
                            <div class="form-group">
                                <input type="text" class="form-control-input" id="searchName" name="searchName" required>
                                <label class="label-control" for="searchName">Search</label>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="text-container">
                    ...
                    <h2 class="white">add music into your sheet</h2>
